...
\title{\Huge \textbf{[Course Number]:[Course Name]} \\ \huge Massachusetts Institute of Technology \\ \large As taught by \textsc{Prof. [Professor Name]}}
% Author
...
This course covers aspects of [Course] involving:
\begin{displayquote}
[Course Description].\footnote{\url{[Description URL]}}
\end{displayquote}


\section*{Structure of Notes}
% You might want to add short description about each chapter in this book.
Each chapter will focus on some broad concept of the course (along the lines of
one chaper per test). Within a chaper, each section approximately corresponds to
one lecture. Each section contains an overview of the lecture's concepts, followed
by exaple problems taken from the lecture, recitations, or from homework.

\section*{Distribution}
All relevent notes and information are made available on github\footnote{\url{https://github.com/JacksonKearl/MIT}}.
This includes:
\begin{itemize}
