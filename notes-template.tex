...
\title{\Huge \textbf{18.02: Multivariate Calculus} \\ \huge Massachusetts Institute of Technology \\ \large As taught by \textsc{Prof. John Bush}}
% Author
...
% NEW CHAPTER! %
%%%%%%%%%%%%%%%%
\chapter{Matricies, Vectors, and their Basic Operations}
